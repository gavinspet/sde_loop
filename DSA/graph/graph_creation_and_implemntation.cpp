...
void makeAdjacencyMatrix(vector<vector<int>> &adjMatrix,vector<vector<int>>&edges)
{
...
//    basically, we will have 3 inputs:
//    1. no. of nodes
//    2. no. of edges
//    3. edge list
...
// for(int i=0;i<m;i++)
// {
//     cout<<"edge number-"<<(i+1)<<": "<<edges[i][0]<<"-> "<<edges[i][1]<<endl;
// }
